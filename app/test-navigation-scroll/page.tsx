        ...
        <div className="min-h-screen bg-gray-100 p-8">
          ...
          {Array.from({ length: 50 }, (_, i) => (
            <div key={i} className="p-4 mb-4 bg-white rounded shadow">
              ...
              <p>This is content section {i + 1}. The navigation should remain fixed at the top while scrolling.</p>
              <p>The backdrop blur effect should be visible when this content passes behind the navigation.</p>
            </div>
          ))}
        </div>
      </main>
