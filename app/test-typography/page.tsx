        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p style={{ fontSize: '1rem', lineHeight: '1.6' }}>
              This is body text used throughout the application. It maintains readability and
              follows the design system specifications. The line height is set to 1.6 for optimal
              reading comfort.
            </p>
          </div>
