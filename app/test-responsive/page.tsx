...
export default function TestResponsive() {
  const [currentWidth, setCurrentWidth] = useState<number>(typeof window !== 'undefined' ? window.innerWidth : 1024);
    ...
    <div className="p-4">
      <div className="fixed top-0 left-0 right-0 bg-white border-b p-4 z-50">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            onClick={() => setCurrentWidth(typeof window !== 'undefined' ? window.innerWidth : 1024)}
